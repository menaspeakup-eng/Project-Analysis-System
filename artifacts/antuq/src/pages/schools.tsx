...
export default function Schools() {
  return (
    <StaticPageLayout eyebrow="إقرا للمدارس والمراكز التعليمية" title="منصّة إقرا لمدرستك أو مركزك التعليمي">
      <p>
        نساعد المعلمين والمراكز التعليمية ومراكز صعوبات التعلّم على تعليم القراءة والنطق العربي
        بطريقة ممتعة وقابلة للقياس، من خلال لوحة تحكم مخصّصة للمعلم إلى جانب تجربة الطالب
        التفاعلية على "إقرا".
      </p>
