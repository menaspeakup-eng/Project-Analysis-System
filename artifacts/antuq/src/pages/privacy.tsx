...
export default function Privacy() {
  return (
    <StaticPageLayout eyebrow="آخر تحديث: يوليو 2026" title="سياسة الخصوصية">
      <p>
        خصوصية طالبك وبياناته أمانة نأخذها على محمل الجد. توضّح هذه السياسة ما هي البيانات التي
      ...
      <Section title="١. البيانات التي نجمعها">
        <ul className="list-disc pr-6 space-y-2">
          ...
          <li>
            ...
            تحليل النطق، يتم تسجيل صوت الطالب مؤقتاً لغرض التحليل الفوري، وتحسين دقة النموذج.
          </li>
          <li>
      ...
      <Section title="٢. كيف نستخدم البيانات">
        <ul className="list-disc pr-6 space-y-2">
          <li>تقديم تجربة تعليمية مخصّصة لكل طالب ومتابعة تقدّمه.</li>
        ...
        <p>لا نبيع بيانات المستخدمين أو الطلاب لأي طرف ثالث لأغراض تسويقية.</p>
      </Section>

      <Section title="٣. خصوصية الطلاب">
        <p>
          ندرك حساسية جمع بيانات الطلاب. نلتزم بعدم جمع أي بيانات شخصية تتجاوز ما هو ضروري
          لتقديم الخدمة التعليمية، ونوصي بأن يشرف ولي الأمر أو المعلم على إنشاء الحساب لأي طالب
          دون سن الثالثة عشرة. يحق لولي الأمر طلب مراجعة أو حذف بيانات طالبه في أي وقت.
        </p>
      </Section>
