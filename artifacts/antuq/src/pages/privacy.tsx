  ...
  return (
    <StaticPageLayout eyebrow="آخر تحديث: يوليو 2026" title="سياسة الخصوصية">
      ...
      <Section title="٢. كيف نستخدم البيانات">
        ...
        <p>لا نبيع بيانات المستخدمين أو الطلبة لأي طرف ثالث لأغراض تسويقية.</p>
      </Section>

      <Section title="٣. خصوصية الطلبة">
        <p>
          ندرك حساسية جمع بيانات الطلبة. نلتزم بعدم جمع أي بيانات شخصية تتجاوز ما هو ضروري
