...
export default function About() {
  return (
    <StaticPageLayout
      eyebrow="عن المنصة"
      title="منصة إقرا: تعليم القراءة والنطق بالذكاء الاصطناعي"
    >
      <p>
        إقرا منصة تعليمية عربية تستخدم الذكاء الاصطناعي لمساعدة الطلبة على تعلم
      ...
      <h2 className="text-2xl font-bold text-foreground">لماذا إقرا؟</h2>
