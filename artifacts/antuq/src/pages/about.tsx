...
export default function About() {
  return (
    ...
    >
      <p>
        انطق منصة تعليمية عربية تستخدم الذكاء الاصطناعي لمساعدة الطلاب على تعلم
      ...
      <p>
        تمكين الطلاب من اكتساب مهارات القراءة والنطق بثقة من خلال محتوى تفاعلي،
      ...
      <ul className="list-disc pr-6 space-y-3">
        ...
        <li>أدوات للمعلمين لمتابعة تقدم الطلاب بسهولة.</li>
      </ul>
    </StaticPageLayout>
  );
}
