...
const faqs = [
  {
    question: "ما هي منصة إقرا؟",
    answer:
      "إقرا منصة تعليمية عربية تستخدم الذكاء الاصطناعي لتعليم الطلبة القراءة والنطق الصحيح للغة العربية عبر ألعاب وقصص تفاعلية.",
  },
  {
    question: "من يمكنه استخدام إقرا؟",
    answer:
  ...
  },
  {
    ...
    answer:
      "نعم، إقرا خالية من الإعلانات والمحتوى غير المناسب. جميع البيانات محمية ولا يمكن الوصول إليها إلا من قبل المستخدم المصرح له.",
  },
  {
  ...
  {
    question: "هل يمكن استخدام إقرا على الهاتف والكمبيوتر؟",
    answer:
...
export default function FAQ() {
  return (
    <StaticPageLayout
      ...
      title="كل ما تريد معرفته عن إقرا"
    >
      <p>
