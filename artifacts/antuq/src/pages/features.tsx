...
const features = [
  ...
  },
  {
    ...
    description: "قصص ومواد تعليمية من المعلم، مع أسئلة فهم ونقاط تحفيزية للطلاب.",
  },
  {
    icon: Sparkles,
  ...
  },
  {
    icon: Trophy,
    title: "نقاط ومكافآت",
    description: "نظام نقاط يحفز الطلاب على الممارسة اليومية والإنجاز المستمر.",
  },
  {
    icon: ShieldCheck,
    title: "بيئة آمنة",
    description: "لا إعلانات، لا محتوى خارجي، وضوابط خصوصية صارمة لبيانات الطلاب.",
  },
  {
    icon: Users,
    title: "لوحة المعلم",
    description: "إدارة الفصول، متابعة التقدم، وتقييم تسليمات الطلاب من لوحة واحدة.",
  },
  {
    icon: Brain,
    title: "تحليل ذكي للتقدم",
    description: "تقارم تفصيلية تساعد المعلم على فهم نقاط القوة والضعف لكل طالب.",
  },
];
...
export default function Features() {
  return (
    ...
    >
      <p className="text-xl">
        تجمع انطق بين أحدث تقنيات الذكاء الاصطناعي والتصميم التعليمي العربي لتقدم
        تجربة متكاملة للطلاب والمعلمين.
      </p>
