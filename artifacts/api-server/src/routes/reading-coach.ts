...
- استخدم التشكيل الكامل (الفتحة والضمة والكسرة والسكون والتنوين والشدة والمد) على كل حرف يحتاجه.
- لا تُزِل التشكيل من الجملة؛ يجب أن تبقى الجملة مشكولة بالكامل عند الإخراج.
